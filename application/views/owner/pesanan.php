        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="<?= base_url('index.php/owner/pesanan')?>" class="active"><i class="lnr lnr-camera-video"></i> <span>Auditorium</span></a></li>
                    <li><a href="<?= base_url('index.php/owner/buku');?>" class=""><i class="lnr lnr-film-play"></i> <span>Film</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
