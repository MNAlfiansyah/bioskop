        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="<?= base_url('index.php/owner/pesanan')?>" class=""><i class="lnr lnr-camera-video"></i> <span>Auditorium</span></a></li>
                    <li><a href="<?= base_url('index.php/owner/buku')?>" class="active"><i class="lnr lnr-film-play"></i> <span>Film</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
                        ...
                        <form action="<?php echo base_url('index.php/owner/gambar')?>" enctype="multipart/form-data" method="post" id="form" class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3" for="nama">Nama Film</label>
                                    <div class="col-md-9">
        ...
        foreach($mas->result_array() as $i):
         ...
         <div class="modal fade" id="modal_edit<?php echo $id_masakan;?>" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                       <h3 class="modal-title" id="myModalLabel">Edit Film</h3>
                   </div>
                   <div class="modal-body form">
